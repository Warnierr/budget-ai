...
export function CSVDropzone({ onFileSelect, isLoading, error, success }: CSVDropzoneProps) {
  ...
  return (
    <label
      htmlFor={inputId}
      className={`block border-2 border-dashed rounded-lg transition-colors cursor-pointer ${
        isDragging
          ...
          : success
            ...
            : error
              ...
              : 'border-gray-300 hover:border-gray-400 dark:border-gray-700 bg-white dark:bg-gray-900'
      }`}
